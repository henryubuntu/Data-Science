...
+ And also the suggestion is that if you are older than 18 years and finish this course, destroy or trow to garbage your Kinder, Primary School, Secondary School, High School Certificate and University degree, they are useless, companies prefer knowledge not papers (if we are ever stopped by any executive that says that we are unable to have administrative or CEO positions for lack of papers in any country of the world, let's all together stop working at the same time in all the companies, we will see if a paper or cerficate save their systems, for and/or in the case that any country politics or laws stablish that managers must a have degree to get that position, whereas be in the government or not [remember that those laws are old and not updated for todays' age])
